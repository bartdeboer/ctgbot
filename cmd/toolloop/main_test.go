...
func TestRunConversationModeCreatesAndResumesConversation(t *testing.T) {
	...
	if err := runConversationMode([]string{"hello"}, conversationDir, outputPath, nil); err != nil {
	...
	if err := runConversationMode([]string{"resume", result.ConversationID, "again"}, conversationDir, outputPath, nil); err != nil {
