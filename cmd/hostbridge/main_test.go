	...
	tests := []struct {
	...
	}{
		{
			...
			contains: []string{
				...
				"thread [ <thread> | config | label | list | managed-file | status | help ] - thread messaging, config, and attention controls",
		...
		},
		{
			...
			contains: []string{
				...
				"thread [ <thread> | config | label | list | managed-file | status | help ] - Thread commands",
			},
			occursOnce: []string{
				"thread [ <thread> | config | label | list | managed-file | status | help ] - Thread commands",
			},
