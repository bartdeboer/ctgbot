...
type Component struct {
	ID        modeluuid.UUID `gorm:"primaryKey"`
	Type      string         `gorm:"index;uniqueIndex:idx_v3_component_type_name"`
	Name      string         `gorm:"uniqueIndex:idx_v3_component_type_name"`
	Label     string
	Enabled   bool
	IsDefault bool
...
type ChatComponent struct {
	ID             modeluuid.UUID    `gorm:"primaryKey"`
	ChatID         modeluuid.UUID    `gorm:"index;uniqueIndex:idx_v3_chat_component_role"`
	ComponentID    modeluuid.UUID    `gorm:"uniqueIndex:idx_v3_chat_component_role"`
	Role           ChatComponentRole `gorm:"uniqueIndex:idx_v3_chat_component_role"`
