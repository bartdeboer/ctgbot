...
func (c *Component) CommandDefinitions() []commandengine.Definition {
	return []commandengine.Definition{
		...
		},
		{
			...
			Help:                  "List persistent thread config values",
		...
		},
		{
			...
			Help:                  "Show a persistent thread config value",
		...
		},
		{
			...
			Help:    "Update a persistent thread config value",
...
func (c *Component) handleThreadConfigGet(ctx context.Context, req commandengine.Request, cmd threadConfigGetCommand) (commandengine.Result, error) {
	...
	key, value, err := c.Service.ThreadConfigGet(ctx, req.Context.Actor, threadID, cmd.Key)
	if err != nil {
		return commandengine.Result{}, err
	}
...
func (c *Component) handleMessageSend(ctx context.Context, req commandengine.Request, cmd messageSendCommand) (commandengine.Result, error) {
	...
	if !sourceThreadID.IsNull() {
		...
		inbound.PromptContext.ReplyHint = "hostbridge thread " + sourceThreadID.String() + " message send"
	}
